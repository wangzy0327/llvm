macro(configure_out_of_tree_llvm)
  ...
  set(LLVM_CMAKE_PATH "$ENV{DPCPP_HOME}/build-2022-12-mlu/lib/cmake/llvm")
  set(CMAKE_PREFIX_PATH "$ENV{DPCPP_HOME}/build-2022-12-mlu")
  ...
  message(STATUS "###### LLVM DIR is ${LLVM_DIR}")
  list(APPEND CMAKE_MODULE_PATH ${LLVM_DIR})
  find_package(Clang REQUIRED HINTS "${CLANG_CMAKE_PATH}")
  message(STATUS "###### CLANG DIR is ${Clang_DIR}")
  ...
  message(STATUS "###### LLVM-as Target Location is ${LLVM_AS}")
  message(STATUS "###### LLVM-link Target Location is ${LLVM_LINK}")
  message(STATUS "###### LLVM OPT Target Location is ${LLVM_OPT}")
  # get_target_property(LIBCLC_REMANGLER libclc-remangler LOCATION)
  # get_property(LIBCLC_REMANGLER  TARGET libclc-remangler PROPERTY LOCATION)
  set(LIBCLC_REMANGLER "${CMAKE_PREFIX_PATH}/bin/libclc-remangler")
  message(STATUS "###### LLVM libclc-remangler Target Location is ${LIBCLC_REMANGLER}")
